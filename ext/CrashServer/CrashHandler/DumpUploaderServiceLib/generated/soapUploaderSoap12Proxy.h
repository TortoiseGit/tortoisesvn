...
#ifndef soapUploaderSoap12Proxy_H
#define soapUploaderSoap12Proxy_H
#include "soapH.h"

class SOAP_CMAC UploaderSoap12Proxy : public soap
{ public:
    /// Endpoint URL of service 'UploaderSoap12Proxy' (change as needed)
    const char *soap_endpoint;
    /// Constructor
    UploaderSoap12Proxy();
    /// Constructor with copy of another engine state
    UploaderSoap12Proxy(const struct soap&);
    /// Constructor with engine input+output mode control
    UploaderSoap12Proxy(soap_mode iomode);
    /// Constructor with engine input and output mode control
    UploaderSoap12Proxy(soap_mode imode, soap_mode omode);
    /// Destructor frees deserialized data
    virtual ~UploaderSoap12Proxy();
    /// Initializer used by constructors
    virtual void UploaderSoap12Proxy_init(soap_mode imode, soap_mode omode);
