...
CXXFLAGS=-Zi -TP -MP -W0 -EHsc -Zc:forScope -Zc:wchar_t -D_CRT_SECURE_NO_DEPRECATE=1 -D_USING_V110_SDK71_
CXXDEBUG=-Od -MDd -DDEBUG
CXXNDEBUG=-O2 -MD -DNDEBUG -GL
NAME=-Fo
LDFLAGS=-OPT:REF,ICF -LTCG -DEBUG -RELEASE $(SUBSYSTEM)
LDDEBUG=
