...
svn mv original original2
svn up
svn ci -m ""
:: revision 63

svn mv original2\original\Ordner trunk\Ord
svn up
svn ci -m ""
:: revision 64

echo modified2 > trunk\Ord\file1
svn ci -m ""
:: revision 65

svn mv %REPOROOT%/tags/5.2.2 %REPOROOT%/tags/05.2.2 -m ""
:: revision 66

svn cp %REPOROOT%/trunk %REPOROOT%/tags/5.2.3 -m ""
:: revision 67

svn rm %REPOROOT%/tags/5.2.3 -m ""
:: revision 68

svn up
echo modified > trunk\Ord\file1
svn ci -m ""
:: revision 69
