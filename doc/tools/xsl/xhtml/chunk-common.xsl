...
<xsl:template name="header.navigation">
  ...
  <xsl:variable name="row2" select="count($prev) &gt; 0                                     or (count($up) &gt; 0                                          and $up != $home                                         and $navig.showtitles != 0)                                     or count($next) &gt; 0"/>
...
<xsl:template name="footer.navigation">
  ...
  <xsl:variable name="row2" select="($prev and $navig.showtitles != 0)                                     or ($home != . or $nav.context = 'toc')                                     or ($chunk.tocs.and.lots != 0                                         and $nav.context != 'toc')                                     or ($next and $navig.showtitles != 0)"/>
