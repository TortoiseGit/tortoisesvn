...
if "%1"=="" (
%PLINK% shell.sourceforge.net -l %USERNAME% -pw %PASSWORD% unzip -o /home/groups/t/to/tortoisesvn/htdocs/docs/docs.zip -d /home/groups/t/to/tortoisesvn/htdocs/docs/nightly;chmod -R g+rw /home/groups/t/to/tortoisesvn/htdocs/docs/nightly;rm -f docs.zip
) else (
%PLINK% shell.sourceforge.net -l %USERNAME% -pw %PASSWORD% unzip -o /home/groups/t/to/tortoisesvn/htdocs/docs/docs.zip -d /home/groups/t/to/tortoisesvn/htdocs/docs/release;chmod -R g+rw /home/groups/t/to/tortoisesvn/htdocs/docs/release;rm -f docs.zip
)
del docs.zip
