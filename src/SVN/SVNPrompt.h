...
public:
	...
	static svn_error_t* sslserverprompt(svn_auth_cred_server_ssl_t **cred_p, void *baton, int failures, const svn_auth_ssl_server_cert_info_t *cert_info, apr_pool_t *pool);
