...
// Copyright (C) 2003-2006, 2008-2010, 2012, 2014-2015, 2021 - TortoiseSVN
...
{
    m_lastError = RegSetValueEx(hKey, m_key, 0, REG_BINARY, reinterpret_cast<BYTE*>(const_cast<LPRECT>(static_cast<LPCRECT>(value))), sizeof(value));
}
...
{
    m_lastError = RegSetValueEx(hKey, m_key, 0, REG_BINARY, reinterpret_cast<BYTE*>(const_cast<POINT*>(static_cast<const POINT*>(&value))), sizeof(value));
}
#endif
