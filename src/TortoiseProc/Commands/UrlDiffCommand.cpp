...
// Copyright (C) 2007-2008, 2010-2011, 2013-2015 - TortoiseSVN
...
bool UrlDiffCommand::Execute()
{
    ...
    if (dlg.DoModal() == IDOK)
    {
        ...
        bRet = diff.ShowCompare(cmdLinePath, SVNRev::REV_WC, CTSVNPath(dlg.m_URL), dlg.Revision, SVNRev(), ignoreprops, dlg.m_sDiffOptions);
    }
    return bRet;
}
