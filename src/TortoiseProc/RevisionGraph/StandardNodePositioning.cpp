...
// Copyright (C) 2003-2009, 2014-2015, 2019-2020 - TortoiseSVN
    ...
    , std::vector<long>& localColumnEnds) const
{
    ...
    start->treeShift.cx = (LONG)(insertionIndex * 250);
...
void CStandardNodePositioning::SetReduceCrossLines
    (IRevisionGraphOption* redCrossLines)
{
    this->reduceCrossLines = redCrossLines;
}

// cast @a layout pointer to the respective modification
// interface and write the data.

void CStandardNodePositioning::ApplyTo (IRevisionGraphLayout* layout, HWND /*hWnd*/)
{
