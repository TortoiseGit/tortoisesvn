...
IMPLEMENT_DYNAMIC(CSettingsTBlame, CPropertyPage)

CSettingsTBlame::CSettingsTBlame()
	: CPropertyPage(CSettingsTBlame::IDD)
	, m_dwFontSize(0)
	, m_sFontName(_T(""))
	, m_dwTabSize(4)
{
...
BEGIN_MESSAGE_MAP(CSettingsTBlame, CPropertyPage)
