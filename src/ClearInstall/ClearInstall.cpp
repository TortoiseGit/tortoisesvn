// ClearInstall.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "ClearInstall.h"
#include "shlwapi.h"
                     ...
                     int       nCmdShow)
{
	...
	::MessageBox(NULL, _T("Registry entries cleaned up!"), _T("TortoiseSVN"), MB_ICONINFORMATION);
}
