...
#define DIFFSTATE_UNKNOWN_DEFAULT_DARK_FG                RGB(255,255,255)
#define DIFFSTATE_NORMAL_DEFAULT_DARK_FG                 RGB(255,255,255)
#define DIFFSTATE_REMOVED_DEFAULT_DARK_FG                RGB(255,255,255)
#define DIFFSTATE_REMOVEDWHITESPACE_DEFAULT_DARK_FG      RGB(255,255,255)
#define DIFFSTATE_ADDED_DEFAULT_DARK_FG                  RGB(255,255,255)
#define DIFFSTATE_ADDEDWHITESPACE_DEFAULT_DARK_FG        RGB(255,255,255)
#define DIFFSTATE_WHITESPACE_DEFAULT_DARK_FG             RGB(255,255,255)
#define DIFFSTATE_WHITESPACE_DIFF_DEFAULT_DARK_FG        RGB(255,255,255)
#define DIFFSTATE_EMPTY_DEFAULT_DARK_FG                  RGB(255,255,255)
#define DIFFSTATE_CONFLICTED_DEFAULT_DARK_FG             RGB(255,255,255)
#define DIFFSTATE_CONFLICTED_IGNORED_DEFAULT_DARK_FG     RGB(255,255,255)
#define DIFFSTATE_CONFLICTADDED_DEFAULT_DARK_FG          RGB(255,255,255)
#define DIFFSTATE_CONFLICTEMPTY_DEFAULT_DARK_FG          RGB(255,255,255)
#define DIFFSTATE_MOVEDFROM_DEFAULT_DARK_FG              RGB(255,255,255)
#define DIFFSTATE_MOVEDTO_DEFAULT_DARK_FG                RGB(255,255,255)
#define DIFFSTATE_IDENTICAL_MOVEDFROM_DEFAULT_DARK_FG    RGB(255,255,255)
#define DIFFSTATE_IDENTICAL_MOVEDTO_DEFAULT_DARK_FG      RGB(255,255,255)
#define DIFFSTATE_IDENTICALREMOVED_DEFAULT_DARK_FG       RGB(255,255,255)
#define DIFFSTATE_IDENTICALADDED_DEFAULT_DARK_FG         RGB(255,255,255)
#define DIFFSTATE_THEIRSREMOVED_DEFAULT_DARK_FG          RGB(255,255,255)
#define DIFFSTATE_THEIRSADDED_DEFAULT_DARK_FG            RGB(255,255,255)
#define DIFFSTATE_YOURSREMOVED_DEFAULT_DARK_FG           RGB(255,255,255)
#define DIFFSTATE_YOURSADDED_DEFAULT_DARK_FG             RGB(255,255,255)
#define DIFFSTATE_CONFLICTRESOLVED_DEFAULT_DARK_FG       RGB(255,255,255)
#define DIFFSTATE_EDITED_DEFAULT_DARK_FG                 RGB(255,255,255)

#define DIFFSTATE_UNKNOWN_DEFAULT_DARK_BG                RGB(0,0,0)
#define DIFFSTATE_NORMAL_DEFAULT_DARK_BG                 RGB(0,0,0)
