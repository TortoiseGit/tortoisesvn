...
protected:
    ...
    static DWORD GetSettingsMap() { return CRegDWORD(_T("Software\\TortoiseMerge\\FixBeforeSave"), (DWORD)0xAAA9); }
    static void SetSettingsMap(DWORD nNewMap) { CRegDWORD(_T("Software\\TortoiseMerge\\FixBeforeSave"), (DWORD)0xAAA9) = nNewMap; }
