...
..\..\bin\release\restext apply TortoiseProcLang.dll ..\..\bin\TortoiseProc%2.dll Tortoise_%1.po 
..\..\bin\release\restext apply TortoiseMergeLang.dll ..\..\bin\TortoiseMerge%2.dll Tortoise_%1.po 
