...
public:
    CStatusCacheEntry();
    CStatusCacheEntry(const svn_client_status_t* pSVNStatus, __int64 lastWriteTime, bool forceNormal);
    ...
    void SetStatus(const svn_client_status_t* pSVNStatus, bool forceNormal);
